...
public class InhalersStage implements Initializable {

    @FXML
    private TableView<Medicine> inhalersTable;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        select = inhalersTable.getSelectionModel().getSelectedItems() ;
        try {
