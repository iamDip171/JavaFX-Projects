...
public class DropsStage implements Initializable {

    @FXML
    private TableView<Medicine> dropsTable;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        select = dropsTable.getSelectionModel().getSelectedItems() ;
        try {
            list = Database_Management.fletchDataFromMedicine("drops") ;
        } catch (Exception e) {
            e.printStackTrace();
        }
