...
public class TabletStage implements Initializable {

    @FXML
    private TableView<Medicine> tabletTable;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        select = tabletTable.getSelectionModel().getSelectedItems() ;
        try {
            list = Database_Management.fletchDataFromMedicine("tablets") ;
        } catch (Exception e) {
            e.printStackTrace();
        }
