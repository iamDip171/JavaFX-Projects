...
public class LiquidStage implements Initializable {

    @FXML
    private TableView<Medicine> liquidTable;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        select = liquidTable.getSelectionModel().getSelectedItems() ;
        try {
            list = Database_Management.fletchDataFromMedicine("liquids") ;
        } catch (Exception e) {
            e.printStackTrace();
        }
